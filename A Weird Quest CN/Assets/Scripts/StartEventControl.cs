...
public class StartEventControl : MonoBehaviour {
	...
	private string[] levelNames = new string[7] {"家","医院","森林 I","森林 II",
		"森林 III","黑暗洞穴","亡灵宫殿"};   // array of level names
	...
	private int levelNum;                  // the current level number in UserData.xml
	private int currentLevelNum;           // the current level number the player choose
	private static string lockedLevelName = "0"; // the name of the locked level image
